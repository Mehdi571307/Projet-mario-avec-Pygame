...
cloud_img_img = pygame.transform.scale(cloud_img, (tile_size, tile_size))
...
blob_img = pygame.image.load('images/slimeWalk1.png')
platform_x_img = pygame.image.load('images/platform_x.png')
platform_y_img = pygame.image.load('images/platform_y.png')
lava_img = pygame.image.load('images/liquidLavaTop_mid.png')
coin_img = pygame.image.load('images/coins.png')
...
while run:
	...
	screen.blit(cloud_img_img, (tile_size * 2, tile_size * 2))
